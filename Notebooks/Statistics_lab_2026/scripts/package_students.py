...
files += [root/'tutorials/01_basics'/n for n in ['01_basics.Rmd','helpers.R','course.json','exercises.json','data/study.csv','data/replicates.csv','data/investigation.csv','replication.R']]
