...
testServer(server,{
 session$setInputs(copy_factor=1,replicate_owners=FALSE,hist_mode='count',hist_bins=6,hist_width=.1,smooth=1,extreme=34,student='Student',partner='Partner',note_row='One row is one animal.')
