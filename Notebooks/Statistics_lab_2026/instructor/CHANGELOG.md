# Changes for mouse-brain-proteins
...
- Replaced MMSE with BDNF assay signal (relative units) and documented animal-level observation rules.
...
- Added three graded tasks: count 1080 measurements versus 72 animals, follow one animal, and defend the original comparison sample sizes.
