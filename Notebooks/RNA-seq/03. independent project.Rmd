...
Dataset + experimental design description (short)
 - What are the groups/conditions, how many replicates, any covariates (batch, donor, sex, etc.)?
 - A clear statement of the main contrast tested.
...
Visualisation
 ...
 - Expression plot for 1–2 marker genes across conditions (boxplot/violin)
