...
3.Reproduce the heatmap in figure 2c of the [paper](https://www.sciencedirect.com/science/article/pii/S2589004222015516). Use vsd - variance stabilized data (output of vst function) and plot both up- and down- regulated genes. 
...
- Extract these expression values of these genes from vsd matrix and visualize their expression across time points using a heatmap. If a gene from GO term is missing in the count matrix and you get error, remove that gene from the heatmap. 
- Extract a list of the top 5 upregulated and downregulated genes in this subset, and print their expression. Use heatmap to visualize the expression of these genes. 
