...
<style>
body {
  max-width: 900px; /* Set the desired width */
  margin: 0 auto;   /* Center the document on the page */
}
</style>

## Download the data from GEO (if already don proceed to the next step)
...
## Loading a Single File in DESeq2 Analysis

#### To begin, we load a single file containing gene count data:

```{r}
# Load a single count file
counts1 <- read.table(file='~/SU drive/Teaching/2024/transcriptomics workshop/data/GSE192855_RAW/GSM5766873_1-sc1-D0-ctrl-A.counts.txt.gz', header=TRUE)
...
for(file in file_list){
  ...
  counts_list[[file]] <- setNames(object = matrix[,7],nm = matrix[,1])
}
...
```
## Creating Experimental Metadata in DESeq2 Analysis
