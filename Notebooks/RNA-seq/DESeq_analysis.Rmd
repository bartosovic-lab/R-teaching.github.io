...
For detail explanation of DESeq2 workflow refer to the full DESeq2 [vignette](https://bioconductor.org/packages/release/bioc/vignettes/DESeq2/inst/doc/DESeq2.html)

#### To begin, we load a single file containing gene count data:

```{r}
# Set a working directory to the folder with notebook and data
setwd("~/SU drive/Teaching/2024/transcriptomics workshop/data/GSE192855_RAW/") # Fill in the directory where you have your data

# Validate that the workind directory is correct
getwd()

# Load a single count file
# Here you will need to change the correct name of your file
raw_table <- read.table(file='GSM5766873_1-sc1-D0-ctrl-A.counts.txt.gz', header=TRUE)
head(raw_table)
